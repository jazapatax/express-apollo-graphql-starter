## Crea una aplicación FRONTEND vanilla (A) BACKEND Apollo server (B) y BD Mongo (C) desacoplados entre si (cada uno en su propia infraestructura independiente) para una arquitectura de microservicios
